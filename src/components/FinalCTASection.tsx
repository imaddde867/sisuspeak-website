      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h2
              className="text-3xl font-bold text-white sm:text-4xl lg:text-5xl mb-6 leading-tight"
            ...
            <p className="text-lg text-blue-100 mb-8 leading-relaxed max-w-lg mx-auto lg:mx-0">
              Join thousands of learners who chose conversation over
              memorization. Start speaking naturally from day one.
            </p>
